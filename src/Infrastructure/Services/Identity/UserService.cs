...
using AutoMapper;
using Eventinars.Application.Exceptions;
...
using Eventinars.Infrastructure.Specifications;
using Eventinars.Shared.Constants.Role;
...
namespace Eventinars.Infrastructure.Services.Identity
{
