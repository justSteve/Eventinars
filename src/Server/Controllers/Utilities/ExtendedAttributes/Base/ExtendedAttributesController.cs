...
using Eventinars.Application.Features.ExtendedAttributes.Commands.Delete;
...
using Eventinars.Application.Features.ExtendedAttributes.Queries.GetById;
using Eventinars.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace Eventinars.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
