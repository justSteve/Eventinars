...
using Eventinars.Client.Infrastructure.Authentication;
using Eventinars.Client.Infrastructure.Managers;
using Eventinars.Client.Infrastructure.Managers.Preferences;
...
using Eventinars.Client.Infrastructure.Managers.ExtendedAttribute;
using Eventinars.Domain.Entities.ExtendedAttributes;
using Eventinars.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace Eventinars.Client.Extensions
{
