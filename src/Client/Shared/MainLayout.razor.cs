...
using Eventinars.Client.Infrastructure.Settings;
using Eventinars.Shared.Constants.Application;
...
using Eventinars.Client.Infrastructure.Managers.Identity.Roles;
using Microsoft.AspNetCore.Components;

namespace Eventinars.Client.Shared
{
        ...
        private async Task LoadDataAsync()
        {
            ...
            if (user.Identity?.IsAuthenticated == true)
            {
                if (string.IsNullOrEmpty(CurrentUserId))
                {
                    ...
                    {
                        _snackBar.Add(localizer["You are logged out because the user with your Token has been deleted."],
                            Severity.Error);
